...
* حساب تجريبي فوري (`00000`) مع رصيد 500,000 جنيه لاختبار عمليات الدفع.
* إمكانية تغيير كلمة السر (PIN) وتتبع سجل المعاملات والإيصالات.
...
### 🏦 بوابة الدفع (بنكك):
* **حساب الاختبار السريع (DEMO)**:
  * رقم الحساب: `00000`
  * رمز الـ PIN: `0000`
  * الرصيد: `500,000.00 SDG`
* **الحسابات المسجلة الأخرى**:
  * أرقام الحسابات: من `10001` إلى `10021` (أو رقم الهاتف)
  * رمز الـ PIN الافتراضي: `1234`

### 🛡️ لوحة تحكم الأدمن:
* البريد: `admin@smarttraffic.sd`
