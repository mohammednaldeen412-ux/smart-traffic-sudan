...
class UserModel {
  ...
  factory UserModel.fromJson(Map<String, dynamic> json) {
    String? pUrl = json['profileImageUrl'] as String?;
    // إذا كان الرابط قديم وخربان (يحتوي على Firebase Storage)، نبدله بأفاتار مؤقت
    if (pUrl != null && pUrl.contains('firebasestorage.googleapis.com')) {
      pUrl = 'https://ui-avatars.com/api/?name=${json['fullName'] ?? 'User'}&background=random';
    }
